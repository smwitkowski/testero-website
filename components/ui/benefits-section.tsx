  ...
  return (
    <section className="w-full py-10 sm:py-16 md:py-24 px-4 sm:px-6 relative">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
        ...
        >
          Smarter Prep. <span className="text-orange-500">Less Stress.</span> Results That Speak. 
        </h2>
        ...
        >
          No more outdated PDFs or endless Q&A threads. Testero gives you a smarter, easier path to certification success:
        </p>
        ...
        >
          ...
          <BenefitCard
            ...
            title="Personalized, Targeted Study"
            description="AI pinpoints your weak spots and builds a plan just for you. No wasted effort."
          ...
          <BenefitCard
            ...
            title="Master Material 40% Faster"
            description="Adaptive, always-current questions help you learn what matters most. Get results fast."
            highlight="40% Faster"
          ...
          <BenefitCard
            ...
            description="Live dashboard predicts your pass date. Boost your pass rate by 15 points."
            highlight="15 points"
            highlightColor={colors.accent[500]}
          ...
          <BenefitCard
            ...
            description="Question bank refreshes within 14 days of any exam change. Never study old material."
            highlight="14 days"
            highlightColor={colors.accent[500]}
        ...
        >
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <div className="flex-1 text-center md:text-right">
              <h3 className="text-lg sm:text-xl font-semibold text-red-500 mb-2">Traditional Approach</h3>
              <ul className="list-none space-y-2">
                <li className="flex items-center justify-end">
                  <span>Outdated study materials</span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-red-500 ml-2">
            ...
            <div className="hidden md:block h-40 border-l border-slate-300"></div>
            
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-lg sm:text-xl font-semibold text-green-500 mb-2">Testero Approach</h3>
              <ul className="list-none space-y-2">
