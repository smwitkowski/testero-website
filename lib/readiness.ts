 ...
 * - <40: Low - Needs significant improvement. Focus on foundational concepts and consistent practice.
 * - 40-69: Building - Making progress. Focus on weak areas to reach exam readiness.
 * - 70-84: Ready - Approaching exam readiness. Keep practicing to maintain and strengthen your knowledge.
 * - 85+: Strong - Well-prepared for the exam. Continue practicing to maintain your knowledge.
 * 
...
export function getExamReadinessTier(score: number): ExamReadinessTier {
  if (score < EXAM_LOW_THRESHOLD) {
    return {
      id: "low",
      label: "Low",
      description: "Needs significant improvement. Focus on foundational concepts and consistent practice to build your readiness.",
    };
  }
